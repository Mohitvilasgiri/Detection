'''
Description: Main file to predict the face mask detection using trained model 
Author: Prashant
Team no: 5
Project no: 5
Command to run this file: python main.py -models/deploy.prototxt -cm models/deploy.caffemodel -m models/mask_detector.model
'''
